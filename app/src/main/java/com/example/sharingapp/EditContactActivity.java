...
public class EditContactActivity extends AppCompatActivity implements Observer {
    ...
    public boolean validateInput() {
        ...
        // Check if contact is borrowing an item
        for (Contact active_borrower : item_list_controller.getActiveBorrowers()) {
            if (active_borrower.getId().equals(contact_controller.getId())) {
                username.setError("Contact is currently borrowing an item!");
                return false;
            }
        }
